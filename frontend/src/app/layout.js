    ...
    <html lang="en" className="h-full">
      ...
      <body className={`${inter.variable} font-sans min-h-screen gradient-bg`}>
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
          <div className="absolute top-[-10%] left-[10%] w-[420px] h-[420px] bg-[rgba(91,140,255,0.18)] blur-[56px] rounded-full" />
          <div className="absolute bottom-[-10%] right-[10%] w-[380px] h-[380px] bg-[rgba(99,245,210,0.08)] blur-[56px] rounded-full" />
        </div>
