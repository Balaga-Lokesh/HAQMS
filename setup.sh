...
echo -e ""
echo -e "--------------------------------------------------------------------"
echo -e "Front-end: configure NEXT_PUBLIC_API_BASE_URL for your Vercel deployment"
echo -e "Back-end API: configure Railway environment variables and release command"
echo -e "===================================================================="
